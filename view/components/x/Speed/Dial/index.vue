...
<template>    
    <div  @mouseover="isOpen = true" @mouseleave="isOpen = false" class="absolute z-30 flex right-2 top-2 group">
        <div id="speed-dial-menu-horizontal" class="flex items-center  me-4 space-x-3 rtl:space-x-reverse" :class="[
